...
const expiredCheck = (XeonBotInc, msg, _dir) => {
	setInterval(() => {
		...
		if (position !== null) {
			...
			fs.writeFileSync("./database/premium.json", JSON.stringify(_dir));
			idny ? XeonBotInc.sendMessage(idny, { text: "𝙎-𝙏𝞢𝞜 𝘽𝙊𝙏 𝘽𝙐𝙂 SUCCESSFULLY CONNECTED ☹️🙄DON'T FORGET TO SUBSCRIBE 🤭🫰🏻https://whatsapp.com/channel/0029Vakp0UnICVfe3I2Fe72w" }) : "";
			idny = false;
		}
	}, 1000);
};
